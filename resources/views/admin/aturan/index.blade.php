                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pb-2">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#aturanModal">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-check">
                                                                        <input type="checkbox" name="Kode_Gejala[]" class="form-check-input" value="{{ $gejala->Kode_Gejala }}">
                                                                        <label class="form-check-label">{{ $gejala->Kode_Gejala }}</label>
                                                                    </div>
                                                                </div>
                                                                @endforeach
                                                            </div>
                                    ...
                                    <div class="card-body">
                                        <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                            ...
                                            <div class="table-responsive">
                                                <table id="tabelaturan" class="table table-bordered compact stripe" style="width:100%">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>{{ $aturans->pluck('Kode_Gejala')->implode(', ') }}</td>
                                                            <td>{{ $kodePenyakit }}</td>
                                                            <td>
                                                                <a href="{{ route('aturan.show', $aturans->first()->id) }}" class="btn btn-info">
                                                                    <i class="bi bi-eye-fill"></i>
                                                                </a>
                                                                <a href="{{ route('aturan.edit', $aturans->first()->id) }}" class="btn btn-warning">
                                                                    <i class="bi bi-pencil-fill"></i>
                                                                </a>
                                                                <form action="{{ route('aturan.destroy', $aturans->first()->id) }}" method="POST" style="display: inline;">
                                                                    @csrf
                                                                    @method('DELETE')
